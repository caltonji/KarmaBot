...
module.exports = {
    createBot: function (app, group_id, token, callback) {
    ...
    checkBotCallbackUpdated: function (bot_info, token, callback) {
        var options = {
            hostname: groupMeApiBase,
            port: 443,
    ...
    updateBotCallbackUrl: function (bot_info, token, callback) {
